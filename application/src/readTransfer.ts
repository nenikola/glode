...
async function main() {
    try {
        ...
        await gateway.connect(ccp, {
            ...
            }, identity: 'user1', discovery: { enabled: false, asLocalhost: true }
        });
        ...
        const result = await contract.createTransaction('readTransfer').setEndorsingPeers(endorsers).submit("ocA", "1234");
