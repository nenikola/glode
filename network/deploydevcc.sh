...
# docker logs -f --tail=30 $(docker ps -a  --format "{{.ID}}: {{.Names}}" | grep transfer_ | grep ocA | sed s/:.*$//) | sed -e 's/^/[-- ocA.peer TRANSFER--]/' &  docker logs -f --tail=30 $(docker ps -a  --format "{{.ID}}: {{.Names}}" | grep transfer_ | grep itA | sed s/:.*$//) | sed -e 's/^/[-- itA.peer TRANSFER--]/' &  docker logs -f --tail=30 $(docker ps -a  --format "{{.ID}}: {{.Names}}" | grep transfer_ | grep itB | sed s/:.*$//) | sed -e 's/^/[-- itB.peer TRANSFER--]/' &  docker logs -f --tail=30 $(docker ps -a  --format "{{.ID}}: {{.Names}}" | grep transfer_ | grep ffA | sed s/:.*$//) | sed -e 's/^/[-- ffA.peer TRANSFER--]/' & docker logs -f --tail=30 $(docker ps -a  --format "{{.ID}}: {{.Names}}" | grep booking | grep ocA | sed s/:.*$//) | sed -e 's/^/[-- ocA.peer BOOKING--]/' &  docker logs -f --tail=30 $(docker ps -a  --format "{{.ID}}: {{.Names}}" | grep booking | grep itA | sed s/:.*$//) | sed -e 's/^/[-- itA.peer BOOKING--]/' &  docker logs -f --tail=30 $(docker ps -a  --format "{{.ID}}: {{.Names}}" | grep booking | grep itB | sed s/:.*$//) | sed -e 's/^/[-- itB.peer BOOKING--]/' &  docker logs -f --tail=30 $(docker ps -a  --format "{{.ID}}: {{.Names}}" | grep booking | grep ffA | sed s/:.*$//) | sed -e 's/^/[-- ffA.peer BOOKING--]/' & docker logs -f --tail=30 $(docker ps -a  --format "{{.ID}}: {{.Names}}" | grep transferEquipment | grep ocA | sed s/:.*$//) | sed -e 's/^/[-- ocA.peer TRANSFER EQUIPMENT--]/' &  docker logs -f --tail=30 $(docker ps -a  --format "{{.ID}}: {{.Names}}" | grep transferEquipment | grep itA | sed s/:.*$//) | sed -e 's/^/[-- itA.peer TRANSFER EQUIPMENT--]/' &  docker logs -f --tail=30 $(docker ps -a  --format "{{.ID}}: {{.Names}}" | grep transferEquipment | grep itB | sed s/:.*$//) | sed -e 's/^/[-- itB.peer TRANSFER EQUIPMENT--]/' &  docker logs -f --tail=30 $(docker ps -a  --format "{{.ID}}: {{.Names}}" | grep transferEquipment | grep ffA | sed s/:.*$//) | sed -e 's/^/[-- ffA.peer TRANSFER EQUIPMENT--]/' & 
